    ...
    if (this.props.flipHorizontal) {
      transform.push(
        {rotateY: this.state.rotate.interpolate({
          inputRange: this.props.flipInputRange,
          outputRange: this.props.flipOutputRange
        })}
      )
    }
...
FlipCard.propTypes = {
  ...
  flipInputRange: PropTypes.arrayOf(PropTypes.number),
  flipOutputRange: PropTypes.arrayOf(PropTypes.string),
