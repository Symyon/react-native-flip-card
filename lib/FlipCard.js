...
export default class FlipCard extends Component {
  constructor (props) {
    ...
    const contentSwitchTime = this.props.contentSwitchTime;
    ...
    this.state = {
      ...
      contentSwitchTime: contentSwitchTime,
    }
  }
    ...
    if (this.props.flipHorizontal) {
      transform.push(
        {rotateY: this.state.rotate.interpolate({
          inputRange: [0, 1],
          outputRange: [ '0deg', '179.5deg' ] //the 179deg is for the issue on Android
                                              //when content is disappearing for a limited rotation angle
                                              //even if iOS has no problem, we'll keep it consistent
        })}
      )
    }
...
FlipCard.propTypes = {
  ...
  contentSwitchTime: PropTypes.number,
